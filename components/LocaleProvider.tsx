...
// Import JSON as unknown first to avoid AbstractIntlMessages incompatibility
import enRaw from "@/messages/en.json";
import esRaw from "@/messages/es.json";

const en = enRaw as unknown as AbstractIntlMessages;
const es = esRaw as unknown as AbstractIntlMessages;
